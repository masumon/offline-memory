...
export const typography={label:{fontSize:12,lineHeight:16},body:{fontSize:16,lineHeight:24},bodySmall:{fontSize:14,lineHeight:21},title:{fontSize:30,lineHeight:38},heading:{fontSize:22,lineHeight:29},display:{fontSize:36,lineHeight:44},caption:{fontSize:11,lineHeight:16},titleLarge:{fontSize:32,lineHeight:40},cardTitle:{fontSize:18,lineHeight:24},meta:{fontSize:13,lineHeight:20},input:{fontSize:15,lineHeight:22},section:{fontSize:11,lineHeight:16},bengaliLabel:{fontSize:13,lineHeight:20},bengaliBody:{fontSize:16,lineHeight:26},bengaliHeading:{fontSize:22,lineHeight:30}} as const;
export const radius={sm:8,md:12,lg:18,xl:24,pill:999} as const;
export const control={inputHeight:52,buttonHeight:48,rowMinHeight:64,iconSize:22,iconButtonSize:48,smallIconContainer:40,listIconContainer:44,searchHeight:56,titleIconContainer:52,largeIconSize:44,textareaHeight:220} as const;
