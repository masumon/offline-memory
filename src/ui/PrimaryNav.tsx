...
export function PrimaryNav() {
  ...
  return (
    <View pointerEvents="box-none" style={[styles.host, rail && styles.hostRail]}>
      <View
        style={[
          styles.bar,
          rail && styles.barRail,
          {
            ...
            height: rail ? undefined : layout.compactNavHeight + insets.bottom,
            paddingBottom: rail ? spacing.lg : insets.bottom,
          },
        ]}
      >
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <Text numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.82} style={[styles.label, { color: active ? colors.primary : colors.textSecondary }]}>
                {label}
              </Text>
            </Pressable>
          );
...
const styles = StyleSheet.create({
  ...
  hostRail: { top: 0, right: undefined, width: layout.expandedNavWidth, bottom: 0 },
  ...
  barRail: { flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'stretch', borderTopWidth: 0, borderRightWidth: 1, paddingTop: spacing.lg, paddingHorizontal: spacing.sm, gap: spacing.sm },
  ...
  itemRail: { flex: 0, maxWidth: undefined, minHeight: 68, width: '100%', justifyContent: 'center', paddingHorizontal: spacing.xs },
