...
const RULES: IntentRule[] = [
  ...
  { intent: 'RESCHEDULE_TASK', confidence: 0.95, patterns: [/\b(reschedule|move|postpone|delay)\b/u, /পিছিয়ে দাও/u, /পরে কর/u, /তারিখ বদল/u] },
  ...
  { intent: 'CREATE_TASK', confidence: 0.91, patterns: [/\b(add|create|make|remind me to|todo|task)\b/u, /কাজ যোগ/u, /কাজ কর(?:তে হবে)?/u, /আমাকে মনে করিয়ে দিও/u, /করতে হবে/u] },
];
