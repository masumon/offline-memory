...
const styles = StyleSheet.create({
  ...
  list: { gap: spacing.sm },
  card: { minHeight: 86, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: spacing.lg, justifyContent: 'center' },
  cardTitle: { color: colors.textPrimary, fontSize: 17, fontWeight: '800' },
  cardDescription: { color: colors.textSecondary, fontSize: 13, lineHeight: 19, marginTop: spacing.xs },
});
