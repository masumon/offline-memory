...
jest.mock('expo-file-system', () => {
  ...
  class MockDirectory { exists=true; list=jest.fn(()=>[new MockFile('file:///documents/attachments/valid.bin'),new MockFile('file:///documents/attachments/orphan.bin')]); constructor(..._parts:string[]){} }
